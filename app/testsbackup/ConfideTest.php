...
class ConfideTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testShouldGetUserByEmailOrUsername()
    {
        ...
        $confide = m::mock(
                        ...
                        '[extractIdentityFromArray]', [$repo, $passService, $loginThrottler, $app]
        );
    ...
    public function testShouldDoLogAttempt()
    {
        ...
        $confide = m::mock(
                        'Zizaco\Confide\Confide' .
                        '[extractRememberFromArray,extractIdentityFromArray,loginThrottling]', [$repo, $passService, $loginThrottler, $app]
        );
        $confide->shouldAllowMockingProtectedMethods();
        $user = m::mock('_mockedUser');
        $user->confirmed = true;
    ...
    public function testShouldExtractRememberFromArray()
    {
        ...
        $confide = m::mock(
                        'Zizaco\Confide\Confide' .
                        '[extractRememberFromArray]', [$repo, $passService, $loginThrottler, $app]
        );
        $confide->shouldAllowMockingProtectedMethods();
    ...
    public function testShouldExtractIdentityFromArray()
    {
         ...
         */
        $this->assertEquals(
                false, $confide->extractIdentityFromArray($emptyId)
        );
        $this->assertEquals(
                'someone', $confide->extractIdentityFromArray($userId)
        );
        $this->assertEquals(
                'someone@somewhere.com', $confide->extractIdentityFromArray($emailId)
        );
        $this->assertEquals(
                'someone@somewhere.com', $confide->extractIdentityFromArray($bothId)
        );
    }
    ...
    public function testShouldDoLoginThrottling()
    {
        ...
        $confide = m::mock(
                        'Zizaco\Confide\Confide' .
                        '[loginThrottling]', [$repo, $passService, $loginThrottler, $app]
        );
        $confide->shouldAllowMockingProtectedMethods();
    ...
    public function testIsThrottled()
    {
        ...
        $loginThrottler = m::mock('Zizaco\Confide\LoginThrottleServiceInterface');
        $confide = m::mock(
                        'Zizaco\Confide\Confide[isThrottled]', [$repo, $passService, $loginThrottler, $app]
        );
        $userEmail = 'someone@somewhere.com';
        /*
          |------------------------------------------------------------
    ...
    public function testShouldForgotPassword()
    {
         ...
         */
        $this->assertEquals(
                $generatedToken, $confide->forgotPassword($user->email)
        );
    ...
    public function testShouldDestroyForgotPasswordToken()
    {
        ...
        $loginThrottler = m::mock('Zizaco\Confide\LoginThrottleServiceInterface');
        $confide = m::mock(
                        'Zizaco\Confide\Confide[destroyForgotPasswordToken]', [$repo, $passService, $loginThrottler, $app]
        );
        $token = '123456789';
        /*
          |------------------------------------------------------------
    ...
    public function testShouldMakeViews()
    {
        ...
        $app['view']->shouldReceive('make')
                ->once()->with(
                        'view.confide::reset_password_form', ['token' => $token]
                )
                ->andReturn($view);
