...
// ));
         ...
         */
        $this->assertEquals(
                $generatedToken, $passService->requestChangePassword($user)
        );
    }
...
// ->first();
         ...
         */
        $this->assertEquals(
                $userEmail, $passService->getEmailByToken($token)
        );
    }
...
// ->delete();
    ...
    public function testShouldGetConnection()
    {
         ...
         */
        $this->assertEquals(
                'db_name', $passService->getConnection()
        );
    }
    ...
    public function testShouldGetTable()
    {
         ...
         */
        $this->assertEquals(
                'password_reminders', $passService->getTable()
        );
        $this->assertEquals(
                'the_table', $passService->getTable()
        );
        $this->assertNull(
    ...
    public function testShouldGetOldestValidDate()
    {
         ...
         */
        $this->assertEquals(
                $oldestValidDate, $passService->getOldestValidDate()
        );
    }
