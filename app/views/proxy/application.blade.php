            ...
            <tbody>
                <tr ng-repeat="item in items">
                    <td class="wrapword"><span
                        ...
                        ng-click="apiTokens( item )">[[item.developer_name]]</span><br> <span
                        style="font-style: italic">[[item.email]]</span></td>
                    <td>
                        <div class="wrapword"
                        ...
                        <div style="width: 18%; float: right;">
                            <button type="button" class="btn btn-default btn-sm"
                                ng-click="updateConsumerKey( $index )">
                            <i class="fa fa-refresh"></i>
                            </button>
                        </div>
                    </td>
                    <td class="wrapword"><span style="display: -webkit-box;">[[item.api_secret]]</span>
                    </td>
                    <td>
                        <button type="button" class="btn btn-default btn-sm"
                        ...
                        <button type="button" class="btn btn-success btn-sm"
                            ng-click="assignSchool( item )">Assign School</button>
                    </td>
                </tr>
