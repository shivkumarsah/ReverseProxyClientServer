...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"
	...
	<div class="table-responsive">
		<div class="col-md-4 col-sm-6" style="margin-bottom: 10px;">
			...
			<div style="font-size: 12px; ! important; float: left; color: red; margin-top: 2px;"
	...
	<div id="viewPanel" class="table-responsive" style="height:auto !important;">
		<table class="table table-striped">
			<thead>
				<tr>
					<th style="width: 25%;">
						{{Form::label('name', trans('messages.applications.head_name'), array('class' => 'table-header'))}}
					</th>
					<th style="width: 30%;">
						{{Form::label('head_internal_url', trans('messages.applications.head_internal_url'), array('class' => 'table-header'))}}
					</th>
					<th style="width: 30%;">
						{{Form::label('head_external_url', trans('messages.applications.head_external_url'), array('class' => 'table-header'))}}
					</th>
					<th style="width: 15%;" ng-show="<?php echo $showAction; ?>">
						{{Form::label('head_task', trans('messages.applications.head_task'), array('class' => 'table-header'))}}
					</th>
				</tr>
			</thead>
			<tbody>
				<tr ng-repeat="item in items">
					<td class="wrapword">
                        <span style="cursor: pointer; text-decoration: underline;">
                            <a href="[[item.external_url]]" target="_new">[[item.name]]</a>
                        </span>
					<td>
