...
@section('content')
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"  ng-controller="EnrollmentsCtrl">

    <h1 class="page-header">{{trans('messages.enrollments.page_title')}}</h1>
    <div class="row">
        <div class="col-md-8 col-sm-12" style="text-align: left;margin-bottom: 10px;">
            <span style="font-size: 12px;!important;float: left;" ng-show="enrollments.length !== 0">
                    Page
            ...
            <span style="font-size: 12px;!important;float: left;margin-top:7px;" ng-show="enrollments.length !== 0">
                &nbsp;of [[totalPages]] | View &nbsp;
            </span>
            <span style="font-size: 12px;!important;float: left;margin-top:0px;" ng-show="enrollments.length !== 0">
            ...
            <span style="font-size: 12px;!important;float: left;margin-top:7px;" ng-show="enrollments.length !== 0">
                &nbsp;records | Found total [[enrollmentsCount]] [[ showRecord ]]
             <span>
        </div>
        <div class="col-md-4 col-sm-12" style="margin-bottom: 10px;">
            ...
            <span style="font-size: 12px;!important;float: right;margin-top:0px;">
                &nbsp;
                <button tabindex="6" type="button" class="btn btn-success btn-sm" ng-disabled='!myAction || enrollments.length === 0' style="padding: 4px 10px;" ng-click="exportData( )">
            ...
            <span style="font-size: 12px;!important;float: right;margin-top:0px;" >
                <select ng-disabled="enrollments.length === 0" tabindex="5" class="dropdown-css page-records-drop-down" ng-change="changeAction()" name="myAction" ng-model="myAction" ng-options="actionEle.name for actionEle in listAction" >
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr ng-repeat="enrollment in enrollments ">
                        ...
                        <td class="wrapword">[[enrollment.course_name]]</td>
                        <td class="wrapword">[[enrollment.first_name]]</td>
                        <td class="wrapword">[[enrollment.last_name]]</td>
                    </tr>
                    <tr ng-show="enrollments.length === 0" >
